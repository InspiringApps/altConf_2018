...
class ImagePanel: SCNNode {
	...
	var originalImageNodeScale = SCNVector3()
	var originalImageNodePosition = SCNVector3()
	...
	init(title: String, image: Image?, index: Int) {
		LogFunc()
		...
		let yPosition = ((panelGeometry.height + headerGeometry.height - 10) / 2) * CGFloat(topNode.scale.y)
